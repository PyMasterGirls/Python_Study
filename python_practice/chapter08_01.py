...
# all : iterable 요소 검사 (참, 거짓) all안에 있는 모든 요소 검사해서 모두 다 true여야 true. 하나라도 false면 false 
# any : iterable 요소 검사 (참, 거짓) 하나라도 true면 true
print(all([1, 2, 3]))  # and
print(any([1, 2, 3]))  # or
...
print(round(5.6))  # 6 첫째자리에서 바로 반올림
...
print(list(zip([10,20,30], [40, 50])))  # [(10, 40), (20, 50)]  짝이 맞는 것만 실행
print(type(list(zip([10,20,30], [40, 50, 60])))) # tuple